...
/*
function extractPattern(pattern, path) {
    var route = new RouteParser(pattern);
...
function falsy(val) {
    ...
    if (_.contains(['false', false, '0', 0, 'n', 'N',null,undefined], val)) {
        return false;
    }
    return val;
}
...
function bool(val) {
    ...
    if (_.contains(['true', true, '1', 1, 'y', 'Y'], val)) {
        return true;
    } else if (_.contains(['false', false, '0', 0, 'n', 'N',null,undefined], val)) {
        return false;
    }
    return false;
}
